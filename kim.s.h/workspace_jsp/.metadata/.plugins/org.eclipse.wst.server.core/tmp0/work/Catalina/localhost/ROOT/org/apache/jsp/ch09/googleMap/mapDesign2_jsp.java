 ...
 * Generated at: 2020-05-22 11:45:23 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.ch09.googleMap;
...
*/
      ...
      out.write("\t\t\t/*\r\n");
      out.write("\t\t\t로그인이 성공했을 때 식당리스트 테이블을 그려주기.\r\n");
      out.write("\t\t\t한 부분만 바꿔주기 때문에 아작스를 사용한다.\r\n");
      out.write("\t\t\t아작스를 통해서 가져오고자 하는 것은? json형식의 식당리스트이다.\r\n");
      out.write("\t\t\t아작스가 성공하면 == json 리스트를 잘 가져오면 \r\n");
      out.write("\t\t\tfor문으로 테이블을 그리면서 동시에 그 안에 정보를 배치한다.*********** \r\n");
      out.write("\t\t\t*/\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//alert(\"res 호출성공\");\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t method:\"get\"\r\n");
      out.write("\t\t\t\t,url:\"jsonMapList.jsp\"\r\n");
      out.write("\t\t\t\t,success:function(result){\r\n");
      out.write("\t\t\t\t\t//result.trim(); => 문자열 기준으로 그 앞과 뒤의 공백을 잘라준다. 중간 공백은 자를 수 없다.\r\n");
      out.write("\t\t\t\t\t//result는 json문자열이다. 그 json을 배열로 만들어 주는 함수 JSON.parse(buf)를 사용했다.\r\n");
      out.write("\t\t\t\t\tvar buf = result.trim();\r\n");
      out.write("\t\t\t\t\tvar data = JSON.parse(buf);\r\n");
      out.write("\t\t\t\t\talert(\"data 호출 성공\");\r\n");
      out.write("\t\t\t\t\tvar imsi = '<table border=\"1px\" width=\"220px\" aline=\"center\">';\r\n");
      out.write("\t\t\t\t\timsi += '<thead><td>식당이름</td><td>좋아요</td><td>싫어요</td></thead>';\r\n");
      out.write("\t\t\t\t\tfor(var i=0;i<data.length;i++){\t\r\n");
      out.write("\t\t\t\t\t\timsi += \"<tr><td>\"+data[i].res_name+\"</td><td>\"+ data[i].res_like+\"</td><td>\"+data[i].res_hate+\"</td></tr>\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\timsi += \"</table><br>\";\r\n");
      out.write("\t\t\t\t\timsi += \"<button id='btn_del_rList'>삭제</button><button id='btn_upd_rList'>수정</button>\";\r\n");
      out.write("\t\t\t\t\t//(이것은 자바스크립트) html태그로 div안의 자식 태그에  들어간다.**********\r\n");
      out.write("\t\t\t\t\t//alert(imsi);\r\n");
      out.write("\t\t\t\t\tdocument.getElementById(\"d_resList\").innerHTML = imsi;\r\n");
      out.write("//\t\t\t\t\t제이쿼리로 바꾸면 아래와 같다.\r\n");
      out.write("//\t\t\t\t\t$(\"#d_resList\").html(imsi);\r\n");
      out.write("\t\t\t\t}\t\t\t\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\t\r\n");
      ...
      out.write("\t\t\t\t,url:\"loginAction.jsp\"\r\n");
      out.write("//\t\t\t\t,url:\"loginAction.jsp?mem_id=\"+u_id+\"&mem_pw=\"+u_pw\"\r\n");
      out.write("\t\t\t\t//비동기 통신(ajax)이 완료된다면 \r\n");
      out.write("\t\t\t\t//function(data)의 data에는 loginAction.jsp의 결괏값인 out.print(data)의 data가 담겨 온다. \r\n");
      ...
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t method:\"get\"\r\n");
      out.write("\t\t\t\t,url:\"cookieDelete.jsp\"\r\n");
      ...
      out.write("<!--====================== 로그인 화면  끝  ========================-->\r\n");
      out.write("\r\n");
      out.write("<!-- 로그인이 됐을 때 보여지는 화면이 로그아웃 화면\t -->\t\r\n");
