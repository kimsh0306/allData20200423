...
<body>
<!--============================ 공지사항 등록 Modal 시작 ============================-->
	<div class="modal fade" id="m_upd" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form role="form" id="f_upd">
						<input type="hidden" name="cud" value="upd">	<!-- cud 값 : upd를 파라미터로 넘기기 위해 hidden으로 추가 -->
					...
					<button type="button" class="btn btn-primary" onclick="noticeUpd()">저장</button>
					</form>
					<!--================== form 끝  -->
				</div>
