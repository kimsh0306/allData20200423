				...
				<div class="modal-body">
					...
					<form role="form" id="f_ins">
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" id="c_name" name="c_name" value="상수상수">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" id="c_sports" name="c_sports" value="상수상수">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control input-sm" id="c_startDate" name="c_startDate" value="상수상수">
						</div>
						<div class="form-group">
							<label for="c_endDate"><b>종료일</b></label> 
							<input type="date" class="form-control input-sm" id="c_endDate" name="c_endDate" value="상수상수">
						</div>
						<div class="form-group">
							<label for="c_totalDays"><b>수업 일수</b></label> 
							<input type="text" class="form-control input-sm" id="c_totalDays" name="c_totalDays" value="상수상수">
						</div>
						<div class="form-group">
							<label for="c_times"><b>수업 횟수</b></label> 
							<input type="text" class="form-control input-sm" id=c_times" name="c_times" value="상수상수">
						</div>
						<div class="form-group">
							<label for="c_intro"><b>수업 소개</b></label> 
							<textarea rows="5" class="form-control" id="c_intro" name="c_intro" value="상수상수">
							</textarea>
						</div>
						<div class="form-group">
							<label for="c_price"><b>가격</b></label> 
							<input type="text" class="form-control input-sm" id="c_price" name="c_price" value="상수상수">
						</div>
						<div class="form-group">
							<label for="c_groupCode"><b>그룹코드</b></label> 
							<input type="text" class="form-control input-sm" id="c_groupCode" name="c_groupCode" value="상수상수">
						</div>
						<div class="form-group">
